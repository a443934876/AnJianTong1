...
public class WebServiceUtil {
    ...
    public static final String HUIWEI_5VHR_URL = "http://www.huiweioa.com/5VHumanResource.asmx";
    ...
    public static String putWebServiceMsg(String[] keys, Object[] values,
        ...
        try {
            ...
            SoapFault soaF = (SoapFault) envelope.bodyIn;
            System.out.println(methodName+"---" + "FaultString:" + soaF.faultstring);
            return "";
        }
    }
    ...
    public static ArrayList<HashMap<String, Object>> getWebServiceMsg(String[] keys, Object[] values, String methodName, String url) throws Exception {
        return getWebServiceMsg(keys, values, methodName, url, HUIWEI_NAMESPACE);
    }

    public static ArrayList<HashMap<String, Object>> getWebServiceMsg(String[] keys, Object[] values, String methodName, String[] getParams_Keys) throws Exception {
        String actionUrl = HUIWEI_NAMESPACE + methodName;
        SoapObject so = new SoapObject(HUIWEI_NAMESPACE, methodName);
        if (keys != null) {
            for (int i = 0; i < keys.length; i++) {
    ...
    public static ArrayList<HashMap<String, Object>> getWebServiceMsg(String[] keys, Object[] values, String methodName, String[] getParams_Keys, String url) throws Exception {
        String actionUrl = WISEBUS_NAMESPACE + methodName;
        SoapObject so = new SoapObject(WISEBUS_NAMESPACE, methodName);
        if (keys != null) {
            for (int i = 0; i < keys.length; i++) {
                so.addProperty(keys[i], values[i]);
            }
    ...
    public static ArrayList<HashMap<String, Object>> getWebServiceMsg(String[] keys, Object[] values, String methodName, String[] getParams_Keys, String url, String nameSpace) throws Exception {
        String actionUrl = nameSpace + methodName;
        SoapObject so = new SoapObject(nameSpace, methodName);
        if (keys != null) {
            for (int i = 0; i < keys.length; i++) {
    ...
    public static String getFirstMsg(String[] keys, Object[] values,
                                     String methodName, String url, String nameSpace) throws Exception {
        String actionUrl = nameSpace + methodName;
        SoapObject so = new SoapObject(nameSpace, methodName);
        if (keys != null) {
    ...
    public static String getMsg(String[] keys, Object[] values,
                                String methodName, String url, String nameSpace) throws Exception {
        String actionUrl = nameSpace + methodName;
        SoapObject so = new SoapObject(nameSpace, methodName);
        if (keys != null) {
