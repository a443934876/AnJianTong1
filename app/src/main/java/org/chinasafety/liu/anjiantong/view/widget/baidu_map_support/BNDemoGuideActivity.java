package org.chinasafety.liu.anjiantong.view.widget.baidu_map_support;
...
public class BNDemoGuideActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent != null) {
            ...
            if (bundle != null) {
                mBNRoutePlanNode = (BNRoutePlanNode) bundle.getSerializable(CompanyMapDetailFragment.ROUTE_PLAN_NODE);
            }
        }
        //显示自定义图标
        if (hd != null) {
