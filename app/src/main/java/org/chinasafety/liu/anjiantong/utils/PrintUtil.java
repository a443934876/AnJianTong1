...
public class PrintUtil {
    ...
    public void printContentLine(String content) throws IOException {
        printText("---" + content + "---");
    }
    ...
    public static void printTest(BluetoothSocket bluetoothSocket, String company_name, String JcbDetailEdit) {
        SimpleDateFormat formatter = new SimpleDateFormat("yyyy年MM月dd日");
        Date curDate = new Date(System.currentTimeMillis());
        String str = formatter.format(curDate);
        String comName = GlobalDataProvider.INSTANCE.getCompanyInfo().getComFullName();
        ...
        try {
            ...
            pUtil.printTwoColumn("编号:", s);
            pUtil.printAlignment(1);
            pUtil.printLargeText("整改通知单");
            pUtil.printLine(2);
            pUtil.printContentLine("第一联：此联临检单位留存");
            pUtil.printAlignment(0);
            pUtil.printLine(2);
            pUtil.printTwoColumn("时间:", str);
            pUtil.printLine(2);
            pUtil.printTwoColumn("被检查单位:", company_name);
            pUtil.printLine(2);
            pUtil.printTwoColumn("临检部门:", "");
            pUtil.printLine();
            pUtil.printTwoColumn("", comName);
            pUtil.printLine(2);
            pUtil.printTwoColumn("存在问题:", "");
            pUtil.printLine();
            pUtil.printText(JcbDetailEdit);
            pUtil.printLine(4);
            pUtil.printTwoColumn("检查人员:", "");
            pUtil.printLine(4);
            pUtil.printTwoColumn("整改责任人:", "");
            pUtil.printLine(2);
            // 分隔线
            pUtil.printDashLine();
            pUtil.printLine(2);
            ...
            pUtil.printLargeText("整改通知单");
            pUtil.printLine(2);
            pUtil.printContentLine("第二联：此联被检查对象留存");
            pUtil.printAlignment(0);
            pUtil.printLine(2);
            pUtil.printTwoColumn("时间:", str);
            pUtil.printLine(2);
